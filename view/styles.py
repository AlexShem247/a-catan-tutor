from config.view_constants import ENDGAME_BADGE_BORDER_RADIUS_PX, ENDGAME_BADGE_FONT_WEIGHT, \
    ENDGAME_BADGE_PADDING, ENDGAME_FEEDBACK_CARD_BORDER_RADIUS_PX, ENDGAME_FEEDBACK_CARD_PADDING, \
    ENDGAME_RANK_CARD_SELECTED_BACKGROUND_COLOR, ENDGAME_RANK_CARD_DEFAULT_BACKGROUND_COLOR, \
    ENDGAME_RANK_CARD_SELECTED_BORDER_COLOR, ENDGAME_RANK_CARD_DEFAULT_BORDER_COLOR, \
    ENDGAME_RANK_CARD_SELECTED_BORDER_WIDTH_PX, ENDGAME_RANK_CARD_DEFAULT_BORDER_WIDTH_PX, \
    ENDGAME_RANK_CARD_BORDER_RADIUS_PX, ENDGAME_RANK_CARD_PADDING, ENDGAME_RANK_CARD_FONT_WEIGHT, \
    PLAYER_BADGE_BORDER_RADIUS_PX, PLAYER_BADGE_FONT_WEIGHT
...
def endgame_badge_stylesheet(label: str) -> str:
    badge_base = (
        f"border-radius: {ENDGAME_BADGE_BORDER_RADIUS_PX}px; "
